...
*/
Flight::register('module','ModLoader',['safe/modules',function($dir){Flight::path($dir);}]);
...
*/
Flight::register('view', 'Templum', ['safe/views'], function($view){
...
/*******************************************************************************************
   Map the fly method
*/
Flight::map('fly',[new Pilot(function($url){
...
Flight::map('notFound', function(){
	Flight::fly(new Four04Ctrl(),'four04View'); 
});
